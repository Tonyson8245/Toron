...
public class Vote_history extends AppCompatActivity {
    ...
    String vote_idx,TAG = "Vote_history";
    Vote_detail vote_detail;
    TextView Tv_subject,Tv_description;
    Gson gson = new Gson();


    RecyclerView con_top_recyclerview,pro_top_recyclerview,pros_recyclerview,cons_recycler_view; // 반대 상위 의견, 찬성 상위 의견, 찬성 기사 리스트, 반대 기사 리스트
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,vote_idx,Toast.LENGTH_SHORT).show();
